    ...
    return(
        <section id="work">
            ...
            <div className='col-6 text-center d-flex align-items-center justify-content-center'>
                    <img src = "https://www.sandc.com/globalassets/sac-electric/site-header/sc_color_logo_co_tagline.png" alt = "s&c" width="400" height="100"/>
                </div>
            ...
            <div className='row mt-4 mx-2'>
              ...
              <div className="card text-center shadow rounded">
                ...
                <div className='col-6 text-center d-flex justify-content-center align-items-center'>
                    <img src = "https://hackathon4kids.org/assets/logo.png" width={300} height={300} alt = "hackathon4kids"/>
                </div>
            </div>
            <div className='row mt-4 mx-2'>
                <div className='col-6 text-center d-flex align-items-center justify-content-center'>
