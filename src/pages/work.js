    ...
    return(
        <section id="work">
            ...
            <div className='row mt-4 mx-2'>
                ...
                <a href = "https://www.peritus.ai" target = "_blank">
      ...
      borderRadius: ["20%", "20%", "50%", "50%", "20%"],
                    ...
                    <img src = "https://media.glassdoor.com/sqll/2446898/peritus-ai-squarelogo-1630001415029.png"/>
                </motion.div>
            </div>
            <div className='row mt-4 mx-2'>
                <motion.div className='col-6 text-center d-flex align-items-center justify-content-center' animate={{
      ...
      borderRadius: ["20%", "20%", "50%", "50%", "20%"],
            ...
            <div className='row mt-4 mx-2'>
                <div className='col-6 text-center'>
                <a href = "https://hackathon4kids.org/home.html" target = "_blank">
              <div class="card text-center shadow rounded">
                <div class="card-content">
                  <div class="card-body">
                ...
                <motion.div className='col-6 text-center d-flex justify-content-center align-items-center' animate={{
      scale: [1, 1.25, 1.25, 1, 1],
      rotate: [0, 0, 270, 270, 0],
      borderRadius: ["20%", "20%", "50%", "50%", "20%"],
    }}>
                    <img src = "https://hackathon4kids.org/assets/logo.png" width={300} height={300}/>
                </motion.div>
            </div>
            <div className='row mt-4 mx-2'>
                <motion.div className='col-6 text-center d-flex align-items-center justify-content-center' animate={{
      ...
      borderRadius: ["20%", "20%", "50%", "50%", "20%"],
                ...
                <div className='col-6 text-center'>
                <a href = "https://prathammath.weebly.com/" target = "_blank">
              <div class="card text-center shadow rounded">
                <div class="card-content">
                  <div class="card-body">
