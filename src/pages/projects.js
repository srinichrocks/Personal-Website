...
export default function Projects() {
  return (
   <section id = "projects">
     <Header/>
     <p className='display-4 text-center mt-2'>Featured Projects</p>
     <hr/>
     ...
     <p className='display-4 text-center mt-5 pt-2'>Side Projects</p>
     <hr/>
              ...
              <div class="card text-center h-100 shadow rounded">
                <div class="card-content">
                  <div class="card-body">
                    ...
                    <h6 className='card-subtitle text-primary'>Java</h6>
                    <section className = "card-text text-secondary text-left">
              ...
              <div class="card text-center shadow rounded h-100">
                <div class="card-content">
                  <div class="card-body">
                    ...
                    <h6 className='card-subtitle text-primary'>Python</h6>
                    <section classNamae = "card-text text-secondary text-left">
